function AER1216_Project_q2(block)
...
% 
% Roll
% Input : Desired Roll Angle (rad)
% Output : Actual Roll Angle (rad)
% 
% Pitch 
% Input : Desired Pitch Angle (rad)
% Output : Actual Pitch Angle (rad)
% 
% Yaw
% Input : Desired Yaw Rate (rad/s)
% Output : Actual Yaw Angle (rad)
% 
% Height
% Input : Desired Vertical Speed (m/s)
% Output : Actual Height (m) 
% 
% Pitch-to-u 
% Input : Actual Pitch Angle (rad)
% Output : Actual Forward Velocity (m/s)
% 
% roll-to-v 
% Input : Actual Roll Angle (rad)
% Output : Actual Sideway Velocity (m/s)
% 
% Last updated: Rutvik Solanki 2021-10-12
